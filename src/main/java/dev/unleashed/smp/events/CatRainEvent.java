...
public final class CatRainEvent extends AbstractEvent {
    private int taskId = -1;
    public CatRainEvent() { super("cat_rain"); }
    @Override public @NotNull String getDescription() { return "Cats rain from the sky."; }
    @Override public void onStart(@NotNull EventContext ctx, @NotNull Set<Player> players) {
        final int perTick = cfgInt(ctx, "settings.cats-per-tick", 2);
